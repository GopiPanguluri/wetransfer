...
if ( ! function_exists('profile_img'))
{
	function profile_img($imgPath)
    {
        ...
        {  
          ...
          return $root_path."images/programs/default.jpg";
        }
		else
        {
...
if(!function_exists('prg_img_vid_name'))
{
	function prg_img_vid_name($imgPath)
    {
        //echo $imgPath;exit;
        $root_path = config_item('assets_dir');
		if($imgPath == '')
		...
		else
        {
          //echo $root_path."images/users/".$imgPath;exit;
          //return $root_path.$imgPath;
          return $root_path."images/programs/".$imgPath;
        } 
	}
}
...
if(!function_exists('back_image'))
{
	function back_image($imgPath)
    {
		...
		else
        {
          //echo $root_path."images/users/".$imgPath;exit;
          //return $root_path.$imgPath;
          return $root_path."images/".$imgPath;
        } 
	}
}
