...
class News_model extends CI_Model {
    ...
    public function get_news_list(){
        ...
        $indexId     = '$tableName.n_id';
        $columnOrder = "$tableName.n_id";
        $orderby     = "";
        $joinMe      = "";
        $condition   = " WHERE $tableName.n_id!= '' ";
        //$condition   = " WHERE $tableName.ct_id!= '' AND $tableName.sc_id= '".$_SESSION['admin_user_id']."' ";
