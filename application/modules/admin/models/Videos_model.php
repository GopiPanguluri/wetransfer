...
class Videos_model extends CI_Model {
    ...
    public function get_videos_list() {
        ...
        $tableName2 = 'programs';
        $tableName3 = 'lessions';
        $columns   = array("$tableName.video_id",
                           "$tableName.video_name",
                           "$tableName3.lession_name",
        ...
        $indexId     = '$tableName.video_id';
        $columnOrder = "$tableName.video_id";
        $orderby     = "";
        $joinMe      = "left join $tableName1 on $tableName.chapter_id = $tableName1.chapter_id
         left join $tableName2 on $tableName.program_id = $tableName2.program_id
          left join $tableName3 on $tableName.lession_id = $tableName3.lession_id
         ";
        $condition   = " WHERE $tableName.video_id!= '' ";
        //$condition   = " WHERE $tableName.video_id!= '' AND $tableName.sc_id= '".$_SESSION['admin_user_id']."' ";
