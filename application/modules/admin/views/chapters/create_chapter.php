  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo site_url('admin/chapters'); ?>"><i class="fa fa-university"></i> chapters </a></li>
            <li class="active"> <?php if ($mode == 'edit') {echo "<i class='fa fa-pencil'></i>&nbsp;&nbsp;Edit";}  else if($mode == 'details'){ echo "<i class='fa fa-eye'></i>&nbsp;&nbsp;Details of"; } else {echo "<i class='fa fa-plus'></i>&nbsp;&nbsp;Add";} ?> chapter </li>
        </ol>
      </section>

    <!-- Main content -->
    <input type="hidden" id="page" value="nav-chapters"/>    
    <section class="content">
        <div class="box box-primary">
          <div class="panel-body">
            ...
            <?php
                echo form_open_multipart('admin/chapters/create_chapter', array('id' => 'customer_form', 'class' => 'form-horizontal'));
                if ($mode == 'edit') {
            ?>  
                <div class="form-group">
                    <label class="col-md-2"> Name </label>
                    <div class="col-md-10">
                        <input name="chapter_name" id="chapter_name" type="text" class="form-control" value="<?php echo $item_details['chapter_name']; ?>"/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="col-md-9 col-md-offset-2">
                    <input type="hidden" name="id" id="id" value="<?php echo $item_details['chapter_id']; ?>" />
                    <button type="submit" name="submit" id="submit" val="update" class="btn btn-success">Update </button>
                    <a href="<?php echo site_url('admin/chapters') ?>" class="btn btn-default">Cancel</a>
                </div>
                
            <?php } else if($mode == 'details'){ ?> 
                
                <div class="form-group">
                    <label class="col-md-2"> chapter Name </label>
                    <div class="col-md-4">
                        <?php echo $item_details['chapter_name']; ?>
                    </div>
                    <label class="col-md-2"> chapter Mobile </label>
                    <div class="col-md-4">
                        <?php echo $item_details['chapter_mobile']; ?>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <label class="col-md-2"> chapter Email </label>
                    <div class="col-md-4">
                        <?php echo $item_details['chapter_email']; ?>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <label class="col-md-2"> Class chapter </label>
                    <div class="col-md-4">
                        <?php echo $classes_list[$item_details['class_chapter']]; ?>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-2"> Resume </label>
                    <div class="col-md-4 border_files">
                        <a href="<?php if($item_details['resume']!=''){ echo config_item('root_dir').'assets/images/users/chapter_resume/'.$item_details['resume']; }else{ echo 'javascript:void(0)'; } ?>" target="_blank">Resume uploaded here..</a>
                    </div>
                    ...
                    <div class="col-md-10" style="margin-left: 156px;margin-top: -20px;">
                        <?php if(count($certificates)!=0){ $sno=1; foreach($certificates as $row):?>
                            <div class="border_files col-md-3 text-center" style="margin: 10px;"> 
                              <span class=""> <a target="_blank" href="<?php echo config_item('root_dir').'assets/images/users/chapter_certi/'.$row['tc_name']; ?>"> <i>Click here to see</i> certificate - <?php echo $sno; ?> </a> </span> 
                            </div>
                ...
                <div class="col-md-9">
                    <a href="<?php echo site_url('admin/chapters') ?>" class="btn btn-default">Back</a>
                </div>
            ...
            <?php } else { ?>
                ...
                <div class="form-group">
                    <label class="col-md-2"> Name </label>
                    <div class="col-md-10">
                        <input name="chapter_name" id="chapter_name" type="text" class="form-control" value=""/>
                    </div>
                </div>
                <div class="form-group">
...
<script type="">
    ...
    <?php if ($mode == 'create') { ?>
        ...
        messages:{				
            chapter_name:{					
                required:"chapter Name should not leave empty.",
            },
            program_id:{					
