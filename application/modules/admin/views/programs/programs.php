      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-primary">
            ...
            <a href="<?php echo site_url('admin/programs/create_program'); ?>" data-toggle="tooltip" title="Add New Record" class="btn btn-success btn-background"><i class="fa fa-plus"></i></a>
            <a class="btn btn-danger btn-background deleteme action-links" data-toggle="tooltip" data-tablename="programs" data-fieldname="program_id" title="Delete Selected Records" href="javascript:void(0);" id="" url="<?php echo site_url('admin/delete_all_record'); ?>">
...
<script>
  $(function () {
    $('#banners').DataTable({
      "bServerSide": true,
      "sAjaxSource": "<?php echo site_url('admin/programs/get_programs_list'); ?>",
      "sServerMethod": "POST",
