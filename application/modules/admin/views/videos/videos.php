      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-primary">
            ...
            <a href="<?php echo site_url('admin/videos/create_video'); ?>" data-toggle="tooltip" title="Add New Record" class="btn btn-success btn-background"><i class="fa fa-plus"></i></a>
            <a class="btn btn-danger btn-background deleteme action-links" data-toggle="tooltip" data-tablename="videos" data-fieldname="video_id" title="Delete Selected Records" href="javascript:void(0);" id="" url="<?php echo site_url('admin/delete_all_record'); ?>">
...
<script>
  $(function () {
    $('#banners').DataTable({
      "bServerSide": true,
      "sAjaxSource": "<?php echo site_url('admin/videos/get_videos_list'); ?>",
      "sServerMethod": "POST",
