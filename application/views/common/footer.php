 <!-- FOOTER 1 - LIGHT -->
                <?php $this->load->view('common/footer_nav'); ?>
        </div>
    </div>
    <!-- End BG -->
    </div>
    ...
    <!-- PORTFOLIO FILTER -->
    <script src="<?php echo config_item('frontend_assets');?>js/jquery.isotope.min.js"></script>
    <!-- MAIN SCRIPT -->
    ...
    <script src="<?php echo config_item('ui_base_path').'custom/projects/'; ?>js/mousescroll.js"></script>
    <script src="<?php echo config_item('ui_base_path').'custom/projects/'; ?>js/smoothscroll.js"></script>
    <script src="<?php echo config_item('ui_base_path').'custom/projects/'; ?>js/jquery.prettyPhoto.js"></script>
    <script src="<?php echo config_item('ui_base_path').'custom/projects/'; ?>js/jquery.prettyPhoto.js"></script>
    <script src="<?php echo config_item('ui_base_path').'custom/projects/'; ?>js/jquery.inview.min.js"></script>
    <script src="<?php echo config_item('ui_base_path').'custom/projects/'; ?>js/wow.min.js"></script>
    <script src="<?php echo config_item('ui_base_path').'custom/projects/'; ?>js/main.js"></script>
    <script src="<?php echo config_item('ui_base_path').'custom/projects/'; ?>js/scrolling-nav.js"></script>
    <script>
        new WOW().init();
    </script>
...
//$('.navbar').css('padding','20px 0 !important');
</script>
<script>
