            ...
            <div class="page-title-bg indent-header-1 page-main-content m-bot-40">
                <div class="container">
                    <div class="page-title-container">
                        <div class="row">
                            <div class="col-md-12">
                                <h2><?php if(isset($product_cat_id)){ echo $product_cat_id; }else{ echo 'MATERIAL AND SERVICE DATABASE'; } ?></h2>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active"><?php if(isset($product_cat_id)){ echo $product_cat_id; }else{ echo 'MATERIAL AND SERVICE DATABASE'; } ?></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <aside class="col-md-8 col-lg-9 col-xl-10" id="centerColumn">
                            ...
                            <div class="no_projects_found"></div>
