                                ...
                                <div class="row">
                                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 hidden-xs">
                                        <div class="product-main-image">
                                            <div class="product-main-image__item"><img class="product-zoom" src="<?php echo products_img($product_details['product_image']); ?>" data-zoom-image="<?php echo products_img($product_details['product_image']); ?>" alt="" /></div>
                                    ...
                                    <div class="product-info col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                        ...
                                        <div class="price-box product-info__price"><span class="price-box__new">$<?php echo $product_details['product_price']; ?>.00</span> <span class="price-box__old">$<?php echo $product_details['product_price']; ?>.00</span></div>
                                ...
                                <div class="content">
                                    ...
                                    <div class="tab-content tab-content--ys">
                                        <div role="tabpanel" class="tab-pane active" id="Tab1">
                                            <p><?php echo $product_details['product_image']; ?></p>
