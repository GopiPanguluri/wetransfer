                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <aside class="col-md-8 col-lg-9 col-xl-10" id="centerColumn">
                            <!-- title -->
                            <div class="title-box">
                                <h2 class="text-center text-uppercase title-under"> Projects </h2>
                            </div>
                            <!-- /title -->
                            ...
                            <div class="filters-row border-top-none">
                                <div class="pull-left">
                                    <div class="filters-row__mode">
                                        ...
                                        <a class="filters-row__view active link-row-view btn-img btn-img-view_list"><span></span></a-->
                                    </div>
                            ...
                            <!-- /filters row -->
                            <div class="product-listing row row-view">
