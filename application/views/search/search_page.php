                ...
                <div class="container">
                    ...
                    <div class="row">
                            ...
                            <div class="collapse-block open">
                                ...
                                <div class="collapse-block__content">
                                    <ul class="expander-list">
                                        <?php foreach($list_category as $l){
                                           // print_r($l);
                                         ?>
                                        <li class="active">
                        ...
                        <aside class="col-md-8 col-lg-9 col-xl-10" id="centerColumn">
                            <!-- title -->
                            <div class="title-box">
                                <h2 class="text-center text-uppercase title-under">Product Catalougue </h2>
                            </div>
                            <!-- /title -->
                            ...
                            <div class="product-listing row">
                                <?php foreach($list_products as $row_prod){ ?>
                                                ...
                                                <div class="product__inside__image">
                                                    ...
                                                    <div class="product__inside__carousel slide" data-ride="carousel">
                                                        <div class="carousel-inner" role="listbox">
                                                            <div class="item active"> <a href="product.html"><img src="<?php echo config_item('assets_dir').'images/catelogues/'.$row_prod['product_image'];?>" alt=""></a> </div>
                                                            <?php /* foreach($row_prod['prod_images'] as $row_prod_img): ?>
                                                            <div class="item"> <a href="product.html"><img src="<?php echo config_item('assets_dir').'images/catelogues/'.$row_prod_img['catlogues_name'];?>" alt=""></a> </div>
                                                            <?php endforeach; */ ?>
                                                        </div>
                                                        <!-- Controls -->
